	...
	<div class="container">
		<div class="content">
			...
			if(isset($_POST['save'])){
				...
				$zona_trabajo		 = mysqli_real_escape_string($con,(strip_tags($_POST["zona_trabajo"],ENT_QUOTES)));//Escanpando caracteres 
				...
				$update = mysqli_query($con, "UPDATE empleados SET cedula='$cedula', nombres='$nombres', lugar_nacimiento='$lugar_nacimiento', fecha_nacimiento='$fecha_nacimiento', profesion='$profesion',zona_trabajo='$zona_trabajo',sueldo='$sueldo',departamento='$departamento', direccion='$direccion', telefono='$telefono', puesto='$puesto', estado='$estado' WHERE codigo='$nik'") or die(mysqli_error());
				if($update){
			...
			<form class="form-horizontal" action="" method="post">
				...
				<div class="form-group">
					...
					<div class="col-sm-2">
						<input type="text" name="profesion" value="<?php echo $row ['profesion']; ?>" class="form-control" placeholder="Profesion" required>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-3 control-label">Zona de Trabajo</label>
					<div class="col-sm-2">
						<input type="text" name="zona_trabajo" value="<?php echo $row ['zona_trabajo']; ?>" class="form-control" placeholder="Zona de Trabajo" required>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-3 control-label">Sueldo</label>
					<div class="col-sm-2">
						<input type="text" name="sueldo" value="<?php echo $row ['sueldo']; ?>" class="form-control" placeholder="Sueldo" required>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-3 control-label">Departamento</label>
					<div class="col-sm-2">
						<input type="text" name="departamento" value="<?php echo $row ['departamento']; ?>" class="form-control" placeholder="Departamento" required>
					</div>
				</div>
				<div class="form-group">
