		...
		<div class="content">
			...
			if(isset($_POST['add'])){
				...
				if(mysqli_num_rows($cek) == 0){
						$insert = mysqli_query($con, "INSERT INTO empleados(codigo, cedula, nombres, lugar_nacimiento, fecha_nacimiento, profesion, zona_trabajo, sueldo, departamento, direccion, telefono, puesto, estado)
															VALUES('$codigo', '$cedula','$nombres', '$lugar_nacimiento', '$fecha_nacimiento', '$profesion', '$zona_trabajo', '$sueldo', '$departamento', '$direccion', '$telefono', '$puesto', '$estado')") or die(mysqli_error());
						if($insert){
			...
			<form class="form-horizontal" action="" method="post">
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input type="text" name="zona_trabajo" class="form-control" placeholder="Zona de Trabajo" required>
					</div>
				</div>
				<div class="form-group">
